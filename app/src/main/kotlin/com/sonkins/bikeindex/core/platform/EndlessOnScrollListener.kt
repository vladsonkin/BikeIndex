...
/**
 * This class fires an event when list near the bottom to load next page
 */
abstract class EndlessOnScrollListener(internal val layoutManager: RecyclerView.LayoutManager) :
