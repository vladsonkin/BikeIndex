...
class GetManufacturersUseCase @Inject constructor(private val filterRepository: FilterRepository) {

    suspend fun run(page: Int, perPage: Int) = asyncAwait { filterRepository.getManufacturers(page, perPage) }
}